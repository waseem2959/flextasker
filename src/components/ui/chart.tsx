  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-[#e5e7eb]/50 bg-background px-2.5 py-1.5 text-xs shadow-xl",
          className
        )}
      >
              ...
              {itemConfig?.icon && !hideIcon ? (
                ...
                <div
                  className={cn(
                    ...
                    item.dataKey && `bg-[--color-${item.dataKey}]`
                  )}
                />
              )}
              {itemConfig?.label}
