import { User, Task, Category, Bid, TaskStatus, UserRole, BudgetType, TaskPriority, BidStatus } from '../types';
import { UserImpl } from '../types';
...
export const TASKS: Task[] = [
  ...
  },
  {
    ...
    budget: 15000,
    budgetType: 'NEGOTIABLE' as BudgetType,
    isRemote: true,
    location: 'Remote',
